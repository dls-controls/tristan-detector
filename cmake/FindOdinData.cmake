...
mark_as_advanced(ODINDATA_INCLUDE_DIR FRAMERECEIVER_INCLUDE_DIR FRAMEPROCESSOR_INCLUDE_DIR ODINDATA_LIBRARY)

if (ODINDATA_FOUND)
	set(ODINDATA_INCLUDE_DIRS ${ODINDATA_INCLUDE_DIR} ${FRAMERECEIVER_INCLUDE_DIR} ${FRAMEPROCESSOR_INCLUDE_DIR})
	set(ODINDATA_LIBRARIES ${ODINDATA_LIBRARY} ${FRAMEPROCESSOR_LIBRARY} ${FRAMERECEIVER_LIBRARY})
