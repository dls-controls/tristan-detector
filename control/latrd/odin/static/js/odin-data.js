...
$( document ).ready(function() 
{
  ...
  odin_data.daq = new DAQHolder('tristan-daq-container', 16);
  odin_data.daq.init();
  //var connected = [true, true, true, true, true, true, true, true, true, false, true, true, true, true, true, true];
  //daq.setFRConnected(connected);
